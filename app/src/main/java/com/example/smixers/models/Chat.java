...
public class Chat extends AbstractChat {
    ...
    public Chat(@Nullable String name, @Nullable String message, @NonNull String uid, @NonNull String category_id,@NonNull String description,@NonNull String classId) {
        mName = name;
        mMessage = message;
        mUid = uid;
